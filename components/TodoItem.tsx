  ...
  return (
    ...
    >
      <div className="flex items-start gap-3">
        <Checkbox checked={todo.completed} onCheckedChange={handleToggle} className="h-5 w-5 mt-0.5" />
        ...
        <div className="flex-1 min-w-0">
          {isEditing ? (
            ...
            <>
              ...
              {todo.description && (
                <p className={cn("text-xs text-muted-foreground mt-1", todo.completed && "line-through")}>
                  {todo.description}
                </p>
              )}
            </>
